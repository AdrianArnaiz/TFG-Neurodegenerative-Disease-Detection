...
\newcommand{\nombre}{Adrián Arnaiz Rodríguez} %%% cambio de comando

% Datos de portada
\title{PDDetection\\ Aplicación de técnicas de minería de datos para la detección de la enfermedad del Parkinson}
\author{\nombre}
\tutor{José Francisco Díez Pastor y César Ignacio García Osorio}
\date{\today}
...
\noindent D. José Francisco Díez Pastor y D. César Ignacio García Osorio, profesores del departamento de Ingeniería Civil, área Lenguajes y Sistemas Informáticos.

\noindent Exponen:

\noindent Que el alumno D. \nombre, con DNI 71306880A, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado título de TFG. 
...
Dr. D. César Ignacio García Osorio
\end{flushleft}
\end{minipage}
\hfill
...
\begin{abstract}
\textit{Minería de datos, Clasificador, Análisis del discurso, Parkinson, Aprendizaje automático, Aprendizaje profundo, Procesamiento de audio, Predicción enfermedades.}
\end{abstract}
...
\begin{abstract}
\textit{Data mining, Clasificator, Speech analysis, Parkinson, Machine learning, Deep learning, Audio processing, Disease prediction.}
\end{abstract}
